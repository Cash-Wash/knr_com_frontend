  ...
  return (
    <>
      ...
      <main className="w-full overflow-x-hidden bg-stone-50">
        ...
        {/* ── HERO ── */}
        <section className="relative w-full h-72 sm:h-80 bg-neutral-800 overflow-hidden flex items-center justify-center">
          <div className="absolute inset-0 bg-gradient-to-b from-neutral-700/60 to-neutral-950/80" />
          <motion.div
            initial={{ opacity: 0, y: 30 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.7 }}
            className="relative z-10 flex flex-col items-center gap-4 text-center px-5 pt-24 pb-10"
          >
        ...
        <div className="w-full max-w-[1574px] mx-auto px-5 sm:px-8 py-8">
    ...
    >
      <Link href={`/blog/${article.slug}`} className="flex flex-col h-full">
        ...
        <div className="inline-flex">
          <span className="px-3 py-1 bg-white shadow-sm text-neutral-700 text-xs font-bold font-['Inter']">
            {article.categorie}
          </span>
        </div>
